  ...
  return (
    <div className="space-y-4">
      ...
      <Accordion type="multiple" defaultValue={['general']} className="space-y-2">
        ...
        <AccordionItem value="compra" className="rounded-xl border border-border bg-card px-4">
          <AccordionTrigger className="text-base font-semibold">
            Compra de moto
          </AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="fibra" className="rounded-xl border border-border bg-card px-4">
          <AccordionTrigger className="text-base font-semibold">
            Fibrero
          </AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="tienda" className="rounded-xl border border-border bg-card px-4">
          <AccordionTrigger className="text-base font-semibold">
            Llegada a tienda
          </AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="venta" className="rounded-xl border border-border bg-card px-4">
          <AccordionTrigger className="text-base font-semibold">
            Venta
          </AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="pagos" className="rounded-xl border border-border bg-card px-4">
          <AccordionTrigger className="text-base font-semibold">
            Pagos
          </AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="garantias" className="rounded-xl border border-border bg-card px-4">
          <AccordionTrigger className="text-base font-semibold">
            Garantías
          </AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="reclamos" className="rounded-xl border border-border bg-card px-4">
          <AccordionTrigger className="text-base font-semibold">
            Reclamos
          </AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="tramites" className="rounded-xl border border-border bg-card px-4">
          <AccordionTrigger className="text-base font-semibold">
            Trámites
          </AccordionTrigger>
          <AccordionContent>
