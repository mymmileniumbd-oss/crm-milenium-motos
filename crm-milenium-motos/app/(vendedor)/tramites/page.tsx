  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-[21px] font-extrabold tracking-tight">Trámites</h1>
        <Suspense>
          <TramitesFiltro />
        </Suspense>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card overflow-hidden">
        {tramites.length === 0 ? (
          <p className="p-6 text-muted-foreground text-center">No hay trámites para este mes</p>
        ) : (
          <table className="w-full text-sm">
            <thead className="bg-secondary/40 border-b">
              <tr>
                ...
                <th className="text-left px-4 py-3 font-medium text-muted-foreground">SUNARP estado</th>
                <th className="text-left px-4 py-3 font-medium text-muted-foreground">SUNARP fecha</th>
                <th className="text-left px-4 py-3 font-medium text-muted-foreground">AAP estado</th>
                <th className="text-left px-4 py-3 font-medium text-muted-foreground">AAP fecha</th>
              </tr>
            </thead>
                ...
                return (
                  <tr key={t.id} className="hover:bg-secondary/50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-foreground">
                      {t.sunarp_fecha ?? <span className="text-muted-foreground">—</span>}
                    </td>
                    <td className="px-4 py-3">
                      {t.aap_estado ? (
                    ...
                    <td className="px-4 py-3 text-foreground">
                      {t.aap_fecha ?? <span className="text-muted-foreground">—</span>}
                    </td>
                  </tr>
                )
              })}
