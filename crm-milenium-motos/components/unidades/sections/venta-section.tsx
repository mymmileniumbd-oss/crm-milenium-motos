  ...
  if (!venta && !mostrarForm) {
    return (
      <div className="space-y-2">
        <p className="text-sm text-muted-foreground">No hay venta registrada para esta unidad</p>
    ...
    return (
      <div className="space-y-3">
        <div className="grid grid-cols-2 gap-3 text-sm">
          <div>
            <label className="text-muted-foreground block mb-1">Fecha</label>
            <Input
              type="date"
          ...
          <div>
            <label className="text-muted-foreground block mb-1">Precio (S/)</label>
            <Input
              type="number"
              step="0.01"
              min="0"
          ...
          <div>
            <label className="text-muted-foreground block mb-1">Tipo documento</label>
            <Select
          ...
          <div>
            <label className="text-muted-foreground block mb-1">N° Documento</label>
            <Input
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="p-1.5 text-muted-foreground hover:text-blue-500 hover:bg-blue-50 rounded transition-colors"
          title="Editar venta"
        >
          <Pencil size={15} />
        </button>
